...
const PROJECTS = {
    cephadex: {
        id: "cephadex",
        name: "Cephadex",
        description: "An educational platform allowing for the creation of flashcards, quizzes, games, & tests",
    ...
    "space-portfolio": {
        ...
        description: "This doubles as my portfolio as well as my attempt to go back to basics and build something from scratch. It strengthened my knowledge of webdev since I was previously using React.",
    ...
    "ai-story-tellers": {
        ...
        description: "A never ending story in the form of the game of exquisite cadavre told by many different AIs",
