...
export class ProjectsContentManager {
    ...
    show(targetId) {
        ...
        if (projectToLoad == null) {
            console.error(`project not found for projects content manager: ${targetId}`);
            return;
        }
    ...
    loadProjectContent(project) {
        ...
        const projectContentContainer = fetchElementByID("#projects-content-container");
        ...
        const projectFeaturesContent = fetchElementByID("#project-features-content");
        ...
        projectScreenshot.src = project.screenshotUrl;
    ...
    getNextProjectId(currentProjectId) {
        ...
        return Object.keys(this.PROJECTS)[nextIndex];
    }
    getPreviousProjectId(currentProjectId) {
        const currentIndex = Object.keys(this.PROJECTS).indexOf(currentProjectId);
        const previousIndex = (currentIndex - 1 + Object.keys(this.PROJECTS).length) %
            Object.keys(this.PROJECTS).length;
        return Object.keys(this.PROJECTS)[previousIndex];
    }
    showArrowButtons() {
    ...
    handleProjectNavigation(targetId) {
    ...
    navigateToNextProject() {
        ...
        const nextProjectToLoad = this.PROJECTS[this.getNextProjectId(displayTitleData)];
        if (nextProjectToLoad == null) {
            console.error(`previous project not found, currnet one: ${displayTitleData}`);
            return;
        }
    ...
    navigateToPreviousProject() {
        ...
        const previousProjectToLoad = this.PROJECTS[this.getPreviousProjectId(displayTitleData)];
    ...
    changeMainTitleTo(newTitle, titleData = "display-title") {
        const displayTitle = fetchElementByID("#display-title");
