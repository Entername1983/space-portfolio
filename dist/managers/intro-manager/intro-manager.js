...
export class IntroManager {
    ...
    attachCloseDialogListeners() {
        if (!this.closeDialogButtons?.length)
            return;
        this.closeDialogButtons.forEach((btn) => {
            btn.addEventListener("click", (e) => {
                ...
                exitTl.to(this.dialog, {
                    autoAlpha: 0,
                    duration: 0.6,
                    ease: "power2.inOut",
                }, 0);
                exitTl.to("#welcome-dialog::backdrop", {
                    autoAlpha: 0,
                    duration: 0.6,
                    ease: "power2.inOut",
                }, 0);
    ...
    openWelcomeModal() {
        ...
        gsap.fromTo(this.dialog, { opacity: 0 }, { opacity: 1, duration: 0.6, ease: "back.out(1.7)" });
        gsap.fromTo("#welcome-dialog::backdrop", { opacity: 0 }, { opacity: 1, duration: 0.6 });
    }
    createIntroTl() {
